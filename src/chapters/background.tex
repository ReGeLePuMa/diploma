...
\fig[scale=0.5]{src/img/containers-vs-vms.png}{img:containers-vs-vms}{Containers vs VMs}[2pt]
...
\fig[scale=0.5]{src/img/docker-build-stages.pdf}{img:docker-build-stages}{Steps to containerize an application from a Dockerfile}[2pt]
...
\fig[scale=0.5]{src/img/docker-architecture.pdf}{img:docker-architecture}{Docker architecture}[2pt]
